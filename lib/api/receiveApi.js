...
var ReceiveApiApiKeys;
(function (ReceiveApiApiKeys) {
})(ReceiveApiApiKeys = exports.ReceiveApiApiKeys || (exports.ReceiveApiApiKeys = {}));
class ReceiveApi {
    ...
    setApiKey(key, value) {
        this.authentications[ReceiveApiApiKeys[key]].apiKey = value;
    }
    addInterceptor(interceptor) {
        this.interceptors.push(interceptor);
    }
    createFundingAddress(asset, name, options = { headers: {} }) {
                ...
                return new Promise((resolve, reject) => {
                    localVarRequest(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            ...
                            body = models_1.ObjectSerializer.deserialize(body, "CreateFundingAddressResponse");
    ...
    getFundingAddress(asset, address, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/api/1/funding_address';
            let localVarQueryParameters = {};
            let localVarHeaderParams = Object.assign({}, this._defaultHeaders);
                ...
                return new Promise((resolve, reject) => {
                    localVarRequest(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            ...
                            body = models_1.ObjectSerializer.deserialize(body, "GetFundingAddressResponse");
                            if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                resolve({ response: response, body: body });
                            }
                            else {
