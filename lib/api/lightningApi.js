...
var LightningApiApiKeys;
(function (LightningApiApiKeys) {
})(LightningApiApiKeys = exports.LightningApiApiKeys || (exports.LightningApiApiKeys = {}));
class LightningApi {
    ...
    setApiKey(key, value) {
        this.authentications[LightningApiApiKeys[key]].apiKey = value;
    }
    addInterceptor(interceptor) {
        this.interceptors.push(interceptor);
    }
    getLightningReceive(id, options = { headers: {} }) {
                ...
                return new Promise((resolve, reject) => {
                    localVarRequest(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            ...
                            body = models_1.ObjectSerializer.deserialize(body, "LookupLightningResponse");
    ...
    receiveLightning(amount, currency, expiresAt, description, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (expiresAt !== undefined) {
                localVarQueryParameters['expires_at'] = models_1.ObjectSerializer.serialize(expiresAt, "string");
            }
                ...
                return new Promise((resolve, reject) => {
                    localVarRequest(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            ...
                            body = models_1.ObjectSerializer.deserialize(body, "ReceiveLightningResponse");
                            if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                resolve({ response: response, body: body });
                            }
                            else {
    ...
    sendLightning(paymentRequest, currency, description, externalId, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (paymentRequest !== undefined) {
                localVarQueryParameters['payment_request'] = models_1.ObjectSerializer.serialize(paymentRequest, "string");
            }
            if (description !== undefined) {
                localVarQueryParameters['description'] = models_1.ObjectSerializer.serialize(description, "string");
            }
                ...
                return new Promise((resolve, reject) => {
                    localVarRequest(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            ...
                            body = models_1.ObjectSerializer.deserialize(body, "SendLightningResponse");
                            if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                resolve({ response: response, body: body });
                            }
                            else {
